...
def run_three_v_three():
    ...
    #random fleet list item attacks random herd list item, continues as long as fighter exists within the robots or dinosaurs list
    while len(new_herd.dinosaurs) != 0 or len(new_fleet.robots) != 0:
        ...
        #if statements with break to declare winner
        ...
        #loops through attacks and removes fighter if they reach 0 hitpoints
        attacker_one.attack(attacker_two)
